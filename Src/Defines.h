...
static const char*	gsc_szAppName		= "GLES";	// App strings
static const char*	gsc_szWindowTitle	= "GLES";
static const int	gsc_iTestWidth		= 1280;		// Test size
static const int	gsc_iTestHeight		= 720;
static const int	gsc_iGameWidth		= 640;		// Window size
static const int	gsc_iGameHeight		= 360;
